      ...
      <div className="white-content">
          ...
          <ul className='itemlist'>
              <li className="copy-container">
                  ...
                  <div className="pricing"><span>Status: <em className='color-green'>Avaible</em></span></div>
                  <div className="resultbutton"><button className="green">Claim</button></div>
              </li>
              <li className="copy-container">
                  <span className="domainName">hayriye.zkf</span>
                  <div className="pricing"><span>Status: <em className='color-red'>Not Avaible</em></span></div>
