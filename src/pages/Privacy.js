...
const Privacy = () => { 
  return (
    <div className="text-content pb-5 mb-5">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zkfair Domains.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Zkfair Domains, accessible from <a href="https://zkfair.domains" rel="external nofollow noopener" target="_blank"> https://zkfair.domains</a></p>
        </li>
        <li>
